...
impl Theme {
    ...
    pub fn synthwave() -> Self {
        Self {
            ...
            author: Some("RobbOwen".to_string()),
            ui: AppTheme {
                background: Some(HexColor("#262335".to_string())),
                foreground: Some(HexColor("#ffffff".to_string())),
                normal_mode_bg: HexColor("#362e58".to_string()),
                command_mode_bg: HexColor("#f97e72".to_string()),
                navigator_mode_bg: HexColor("#03edf9".to_string()),
                settings_mode_bg: HexColor("#03edf9".to_string()),
                search_mode_bg: HexColor("#ff7edb".to_string()),
                status_bar_bg: Some(HexColor("#241b2f".to_string())),
                status_bar_fg: Some(HexColor("#362e58".to_string())),
                selection_bg: HexColor("#34294f".to_string()),
                selection_fg: HexColor("#ffffff".to_string()),
                search_highlight_bg: HexColor("#72f1b8".to_string()),
                search_highlight_fg: HexColor("#262335".to_string()),
                shadow_color: Some(HexColor("#1a1a23".to_string())),
                dim: HexColor("#72f1b8".to_string()),
            },
            syntax: SyntaxTheme {
                scene_heading: Some(HexColor("#03edf9".to_string())),
                character: Some(HexColor("#ff7edb".to_string())),
                dialogue: Some(HexColor("#ffffff".to_string())),
                parenthetical: Some(HexColor("#72f1b8".to_string())),
                transition: Some(HexColor("#f97e72".to_string())),
                action: Some(HexColor("#ffffff".to_string())),
                centered: Some(HexColor("#ff7edb".to_string())),
                section: Some(HexColor("#fede5d".to_string())),
                synopsis: Some(HexColor("#72f1b8".to_string())),
                note: Some(HexColor("#72f1b8".to_string())),
                shot: Some(HexColor("#fede5d".to_string())),
                page_break: Some(HexColor("#362e58".to_string())),
                metadata_key: Some(HexColor("#fe4450".to_string())),
                metadata_val: Some(HexColor("#ffffff".to_string())),
            },
            sidebar: SidebarTheme {
                background: Some(HexColor("#241b2f".to_string())),
                border: Some(HexColor("#362e58".to_string())),
                item_selected_bg: Some(HexColor("#ff7edb".to_string())),
                item_selected_fg: Some(HexColor("#262335".to_string())),
                item_dimmed: Some(HexColor("#362e58".to_string())),
                section_header: Some(HexColor("#03edf9".to_string())),
            },
        }
    }
    ...
    pub fn sepia() -> Self {
        Self {
            ...
            author: Some("Fount".to_string()),
            ui: AppTheme {
                background: Some(HexColor("#f4ecd8".to_string())),
                foreground: Some(HexColor("#5b4636".to_string())),
                normal_mode_bg: HexColor("#8b6b5d".to_string()),
                command_mode_bg: HexColor("#c0a080".to_string()),
                navigator_mode_bg: HexColor("#704214".to_string()),
                settings_mode_bg: HexColor("#704214".to_string()),
                search_mode_bg: HexColor("#a0522d".to_string()),
                status_bar_bg: Some(HexColor("#eaddca".to_string())),
                status_bar_fg: Some(HexColor("#5b4636".to_string())),
                selection_bg: HexColor("#d2b48c".to_string()),
                selection_fg: HexColor("#3d2b1f".to_string()),
                search_highlight_bg: HexColor("#cd853f".to_string()),
                search_highlight_fg: HexColor("#f4ecd8".to_string()),
                shadow_color: Some(HexColor("#dcd0b9".to_string())),
                dim: HexColor("#8b6b5d".to_string()),
            },
            syntax: SyntaxTheme {
                scene_heading: Some(HexColor("#704214".to_string())),
                character: Some(HexColor("#8b4513".to_string())),
                dialogue: Some(HexColor("#5b4636".to_string())),
                parenthetical: Some(HexColor("#8b6b5d".to_string())),
                transition: Some(HexColor("#a0522d".to_string())),
                action: Some(HexColor("#5b4636".to_string())),
                centered: Some(HexColor("#8b4513".to_string())),
                section: Some(HexColor("#228b22".to_string())),
                synopsis: Some(HexColor("#8b6b5d".to_string())),
                note: Some(HexColor("#228b22".to_string())),
                shot: Some(HexColor("#cd853f".to_string())),
                page_break: Some(HexColor("#d2b48c".to_string())),
                metadata_key: Some(HexColor("#b22222".to_string())),
                metadata_val: Some(HexColor("#5b4636".to_string())),
            },
            sidebar: SidebarTheme {
                background: Some(HexColor("#eaddca".to_string())),
                border: Some(HexColor("#c0a080".to_string())),
                item_selected_bg: Some(HexColor("#8b4513".to_string())),
                item_selected_fg: Some(HexColor("#f4ecd8".to_string())),
                item_dimmed: Some(HexColor("#8b6b5d".to_string())),
                section_header: Some(HexColor("#704214".to_string())),
            },
        }
    }
    ...
    pub fn hacker() -> Self {
        Self {
            ...
            author: Some("Matrix".to_string()),
            ui: AppTheme {
                background: Some(HexColor("#000000".to_string())),
                foreground: Some(HexColor("#00ff00".to_string())),
                normal_mode_bg: HexColor("#008f11".to_string()),
                command_mode_bg: HexColor("#003b00".to_string()),
                navigator_mode_bg: HexColor("#00ff41".to_string()),
                settings_mode_bg: HexColor("#00ff41".to_string()),
                search_mode_bg: HexColor("#008f11".to_string()),
                status_bar_bg: Some(HexColor("#003b00".to_string())),
                status_bar_fg: Some(HexColor("#00ff00".to_string())),
                selection_bg: HexColor("#003b00".to_string()),
                selection_fg: HexColor("#00ff00".to_string()),
                search_highlight_bg: HexColor("#00ff41".to_string()),
                search_highlight_fg: HexColor("#000000".to_string()),
                shadow_color: Some(HexColor("#001100".to_string())),
                dim: HexColor("#008f11".to_string()),
            },
            syntax: SyntaxTheme {
                scene_heading: Some(HexColor("#00ff41".to_string())),
                character: Some(HexColor("#00ff00".to_string())),
                dialogue: Some(HexColor("#00ff00".to_string())),
                parenthetical: Some(HexColor("#008f11".to_string())),
                transition: Some(HexColor("#00ff41".to_string())),
                action: Some(HexColor("#00ff00".to_string())),
                centered: Some(HexColor("#00ff00".to_string())),
                section: Some(HexColor("#00ff41".to_string())),
                synopsis: Some(HexColor("#008f11".to_string())),
                note: Some(HexColor("#00ff41".to_string())),
                shot: Some(HexColor("#00ff41".to_string())),
                page_break: Some(HexColor("#003b00".to_string())),
                metadata_key: Some(HexColor("#00ff41".to_string())),
                metadata_val: Some(HexColor("#00ff00".to_string())),
            },
            sidebar: SidebarTheme {
                background: Some(HexColor("#000000".to_string())),
                border: Some(HexColor("#003b00".to_string())),
                item_selected_bg: Some(HexColor("#00ff41".to_string())),
                item_selected_fg: Some(HexColor("#000000".to_string())),
                item_dimmed: Some(HexColor("#003b00".to_string())),
                section_header: Some(HexColor("#00ff41".to_string())),
            },
        }
    }
...
impl ThemeManager {
    pub fn new() -> Self {
        ...
        add_theme(Theme::synthwave());
        add_theme(Theme::sepia());
        add_theme(Theme::hacker());
